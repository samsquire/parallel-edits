  ...
  def insert(self, inserts):
    ...
    for insert in inserts:
      if insert.origin.identifier in seen:
        ...
        pass
        # original_right = insert.origin.right
        # insert.original_right = original_right
        # if insert.origin.right:
        #   insert.origin.right.left = insert
        # insert.original_origin_right = insert.origin.right
        
        # insert.origin.right = insert
        # insert.origin_left = insert.left
        # insert.left = insert.origin
        # if original_right:
        #   insert.right = original_right
